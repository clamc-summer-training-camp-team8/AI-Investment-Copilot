...
因此改枚举取值需要同时给出历史数据的映射方案，PR 需规则计算负责人 + AI 能力负责人 + 前端负责人 approve。

## 评审要求

`contracts/` 下的改动需**生产方与消费方双 approve**，由 `.github/CODEOWNERS` 保证。这是刻意设置的摩擦：契约改动的代价由对方承担，所以对方要有话语权。
