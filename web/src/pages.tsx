...
import type { Adjudication, EvidenceFeedItem, EvidenceRetrievalTrace, GoldQualityGate, Hypothesis, IngestionReview, InvestodayCollectionStatus, LogicChangeDigestDetail, MetricDefinition, ProcessingJob, QuantBacktestRequest, QuantBacktestRun, QuantEquityPoint, Relation, ReviewTask, Suggestion, ThesisDetail, ThesisRevision } from './types'
...
function LegacyResearchUpdatesPage() {
...
function LegacyResearchImpactDetailPage() {
