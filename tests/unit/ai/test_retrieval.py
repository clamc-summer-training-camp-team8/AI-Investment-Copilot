...
def test_hybrid_retriever_merges_two_rankings_and_rechecks_filters() -> None:
    lexical_item = RetrievedChunk(
        "doc-lexical", "000538.SZ", "doc-lexical#paragraph-1", "收入增长", _dt(1), "公开", "cninfo", 0.9
    )
    vector_item = RetrievedChunk(
        "doc-vector", "000538.SZ", "doc-vector#paragraph-1", "经营改善", _dt(2), "公开", "cninfo", 0.8
    )
    forbidden_item = RetrievedChunk(
        "doc-private", "000538.SZ", "doc-private#paragraph-1", "内部资料", _dt(2), "内部受限", "internal", 1.0
    )
