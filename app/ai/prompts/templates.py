...
RETROSPECTIVE_DRAFT = _template("retrospective-draft")
HYPOTHESIS_QUALITY = _template("hypothesis-quality")
KNOWLEDGE_ANSWER = _template("knowledge-answer")
LOGIC_CHANGE_CONSOLIDATION = _template("logic-change-consolidation")
...
RETROSPECTIVE_DRAFT_VERSION = RETROSPECTIVE_DRAFT.version
HYPOTHESIS_QUALITY_VERSION = HYPOTHESIS_QUALITY.version
KNOWLEDGE_ANSWER_VERSION = KNOWLEDGE_ANSWER.version
LOGIC_CHANGE_CONSOLIDATION_VERSION = LOGIC_CHANGE_CONSOLIDATION.version
...
ALL_TEMPLATES = {
    ...
    RETROSPECTIVE_DRAFT_VERSION: RETROSPECTIVE_DRAFT,
    HYPOTHESIS_QUALITY_VERSION: HYPOTHESIS_QUALITY,
    KNOWLEDGE_ANSWER_VERSION: KNOWLEDGE_ANSWER,
    LOGIC_CHANGE_CONSOLIDATION_VERSION: LOGIC_CHANGE_CONSOLIDATION,
}
