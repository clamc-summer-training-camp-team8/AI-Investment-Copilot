...
| 文档 | 内容 |
| --- | --- |
| [20260830-Phase 2 集成分支合并记录](20260830-phase2-integrated分支合并记录.md) | Graph RAG、Agent 与完整产品快照三分支的合并裁决、迁移汇合和验收结果 |
| [20260901-Phase 3 三分支功能集成合并记录](20260901-phase3三分支功能集成合并记录.md) | Phase 3 功能、Phase 2 Agent 与自动采集三分支的能力来源、冲突裁决、迁移汇合和验收边界 |
